...
class _JobCard extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final formatCurrency = NumberFormat.simpleCurrency(locale: 'en_IN', name: 'INR', decimalDigits: 0);
              ...
              children: [
                Expanded(
                  child: _InfoChip(
                    ...
                    label: DateFormat('MMM d, h:mm a').format(job.scheduledAt),
                  ),
                ),
                const SizedBox(width: 12),
                Expanded(
                ...
                children: [
                  Expanded(
                    child: FilledButton(
                      onPressed: () async {
                        try {
                          await ref.read(apiClientProvider).post('/bookings/${job.bookingId}/accept-job');
